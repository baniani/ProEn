class LinkedinController < ApplicationController
  API_KEY = '7743zqjgbyjd5b' #Your app's API key
  API_SECRET = 'ldA2JCVH3QSU4Nrl' #Your app's API secret
  REDIRECT_URI = 'http://192.168.1.5:3000/accept' #Redirect users after authentication to this path, ensure that you have set up your routes to handle the callbacks
